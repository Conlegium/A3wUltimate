...
//	systemChat format["StatusBar Initialized", _rscLayer];
	...
	while {true} do 
	{
		...
		_hunger = round (hungerLevel max 0);
		_thirst = round (thirstLevel max 0);
		...
		switch(_minutes) do
	{
		...
		((uiNamespace getVariable "osefStatusBarAdmin")displayCtrl 55554)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%15'><img size='1.0'  shadowColor='#000000' image='client\icons\suatmm_icon.paa' color='%10'/> %9</t> 
